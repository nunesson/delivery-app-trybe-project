const { createSale, findById, update } = require('../Services/Sales.service');
...
const updateSale = async (req, res) => {
  ...
  const sale = await update(id, status);
...
module.exports = { createSaleController, findAll, findOneSale, updateSale };